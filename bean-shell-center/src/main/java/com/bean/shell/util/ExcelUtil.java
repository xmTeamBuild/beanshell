...
import com.bean.shell.listener.PurchaseExcelListener;
...
public class ExcelUtil {
    ...
    public static List<Object> readExcel(MultipartFile excel, BaseRowModel rowModel) {
        PurchaseExcelListener excelListener = new PurchaseExcelListener();
...
//        tableStyle.setTableContentBackGroundColor(IndexedColors.WHITE);
    ...
    private static OutputStream getOutputStream(String fileName, HttpServletResponse response) {
        ...
        try {
            ...
            throw new ExcelCommonException("导出异常！");
        }
    }
     ...
     */
    private static ExcelReader getReader(MultipartFile excel, PurchaseExcelListener excelListener) {
        String filename = excel.getOriginalFilename();

        if (filename == null || (!filename.toLowerCase().endsWith(".xls") && !filename.toLowerCase().endsWith(".xlsx"))) {
            throw new ExcelCommonException("文件格式错误！");
        }
    ...
    public static Object readExcel(InputStream inputStream, Class<? extends BaseRowModel> clazz, Integer sheetNo,
        ...
        PurchaseExcelListener listener = new PurchaseExcelListener();
    ...
    public static ExcelTypeEnum valueOf(InputStream inputStream) {
        try {
            ...
            throw new ExcelCommonException("excelTypeEnum can not null");
